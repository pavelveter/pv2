...
export const DATA = {
  ...
  summary:
    'Всегда с собой запасная техника и переносной студийный свет — никаких форс-мажоров. Фото готовы быстро, но качество всегда в приоритете. Архивы храню годами. Опыт — сотни съёмок, десятки довольных клиентов и тысячи красивых людей на снимках.',
  avatarUrl: '/me.jpg',
  hello: 'Привет, я — ',
  slideshow: 'Портфолио',
